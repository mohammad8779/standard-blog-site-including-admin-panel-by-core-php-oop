        ...
        <div class="block">  
			...
			<tbody>
				...
				<tr class="odd gradeX">
					...
					<td><img src="<?php echo $result['image'];?>" height="50px" width="80px"/></td>
					...
					<td>
						...
						?>
						||<a href="editpost.php?postid=<?php echo $result['id'];?>">Edit</a> || <a href="delpost.php?delpost=<?php echo $result['id'];?>">Delete</a>
						<?php } ?>
					</td>
				</tr>
